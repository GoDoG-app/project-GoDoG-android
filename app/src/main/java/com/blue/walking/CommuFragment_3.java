 ...
 * Use the {@link CommuFragment_3#newInstance} factory method to
 * create an instance of this fragment.
 */
public class CommuFragment_3 extends Fragment {
     ...
     * @return A new instance of fragment CommuFragment_3.
     */
    // TODO: Rename and change types and number of parameters
    public static CommuFragment_3 newInstance(String param1, String param2) {
        CommuFragment_3 fragment = new CommuFragment_3();
    ...
    int count = 0;
    String token;
    int category = 2;  // 정보 카테고리

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_commu_3, container, false);
        ...
        Log.i("recyclerView", "정보 카테고리 카드뷰 띄우기 실행");
