 ...
 * Use the {@link CommuFragment_4#newInstance} factory method to
 * create an instance of this fragment.
 */
public class CommuFragment_4 extends Fragment {
     ...
     * @return A new instance of fragment CommuFragment_4.
     */
    // TODO: Rename and change types and number of parameters
    public static CommuFragment_4 newInstance(String param1, String param2) {
        CommuFragment_4 fragment = new CommuFragment_4();
    ...
    int count = 0;
    String token;
    int category = 3;  // 산책 카테고리

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_commu_4, container, false);
        ...
        Log.i("recyclerView", "산책 카테고리 카드뷰 띄우기 실행");
