...
public class Walking3 extends AppCompatActivity {
    ...
    ArrayList<TMapPoint> linePointList1;
    ArrayList<TMapPoint> passPointList1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        startPoint = new TMapPoint(startLat, startLng); // 출발지
        endPoint =  new TMapPoint(endLat, endLng); // 도착지
        ...
        double randomRadius = 0.0010; // 반경 설정 (임의로 조정)
        ...
        randomPoint1 = new TMapPoint(middlePoint.getLatitude() + randomLatOffset, middlePoint.getLongitude() + randomLngOffset);
        passList.add(randomPoint1); // 랜덤 포인트 가까운거리
                ...
                tMapData.findPathDataWithType(TMapData.TMapPathType.PEDESTRIAN_PATH,
                        startPoint, endPoint, passList, 0, new TMapData.OnFindPathDataWithTypeListener() {
                            ...
                            public void onFindPathDataWithType(TMapPolyLine tMapPolyLine1) {
                                ...
                                linePointList1 = new ArrayList<>();
                                linePointList1.addAll(0,tMapPolyLine1.getLinePointList());
                                passPointList1 = new ArrayList<>();
                                passPointList1 = tMapPolyLine1.getPassPointList();
                                Log.d("저장햇다 라인포", "폴리1pointList"+linePointList1.size());
                                Log.d("저장했다 패스포", "폴리1passList"+passPointList1.size());
        ...
        randomPoint2 = new TMapPoint(middlePoint.getLatitude() + randomLatOffset1, endLng + randomLngOffset1);
        passList1.add(randomPoint2); // 랜덤포인트(경유지) 추가 먼거리
        ...
        tMapView2.setOnMapReadyListener(new TMapView.OnMapReadyListener() {
            ...
            public void onMapReady() {
                ...
                // searchOption string 0: 추천 (기본값), 4: 추천+대로우선, 10: 최단, 30: 최단거리+계단제외
                tMapData.findPathDataWithType(TMapData.TMapPathType.PEDESTRIAN_PATH,
                        startPoint, endPoint, passList1, 0, new TMapData.OnFindPathDataWithTypeListener() {
                            @Override
                            public void onFindPathDataWithType(TMapPolyLine tMapPolyLine2) {
                                ...
                                // 거리 구하기
                                double dist1 = calculateDistance(startLat, startLng, randomPoint2.getLatitude(), randomPoint2.getLongitude());
                                double dist2 = calculateDistance(randomPoint2.getLatitude(), randomPoint2.getLongitude(), endLat, endLng );
                                double dist3 = calculateDistance(endLat, endLng, startLat, startLng);
                                double totalDistance = dist1 + dist2 + dist3;
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Intent intent = new Intent(Walking3.this, WalkingRecoActivity.class);
                        // Intent에 데이터를 추가합니다.
                        ...
                        intent.putExtra("endPointLng", endPoint.getLongitude());
                        intent.putExtra("randomPointLat", randomPoint1.getLatitude());
                        intent.putExtra("randomPointLng", randomPoint1.getLongitude());
                        // WalkingRecoActivity를 시작합니다.
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        intent.putExtra("endPointLat", endPoint.getLatitude());
                        intent.putExtra("endPointLng", endPoint.getLongitude());
                        intent.putExtra("randomPointLat", randomPoint2.getLatitude());
                        intent.putExtra("randomPointLng", randomPoint2.getLongitude());
