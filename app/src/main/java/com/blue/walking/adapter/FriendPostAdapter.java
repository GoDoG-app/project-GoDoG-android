...
public class FriendPostAdapter extends RecyclerView.Adapter<FriendPostAdapter.ViewHolder>{
    ...
    public FriendPostAdapter(Context context, ArrayList<Post> friendPostArrayList) {
    ...
    @NonNull
    @Override
    public FriendPostAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.mypost_row, parent, false);
        return new FriendPostAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull FriendPostAdapter.ViewHolder holder, int position) {
